...
@Component({
  selector: 'app-phardhas',
  templateUrl: './phardhas.component.html',
  styleUrls: ['./phardhas.component.scss']
})
export class PhardhasComponent implements OnInit {
data:any;
_albums: any;
...
url=environment.rootUrl
  ...
  getData() {
    this.service.getPhardha().subscribe(
       res => { 
         this.data = res;
